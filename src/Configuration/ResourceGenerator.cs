...
namespace NFive.PluginManager.Configuration
{
	...
	public static class ResourceGenerator
	{
		...
		/// <see href="https://docs.fivem.net/docs/scripting-reference/resource-manifest/resource-manifest/#fxv2-versions">FiveM Docs</see>
		/// </summary>
		/// <value>
		...
		/// <see href="https://docs.fivem.net/docs/scripting-reference/resource-manifest/resource-manifest/#game">FiveM Docs</see>
		/// </summary>
		/// <value>
		/// FX resource target games.
		/// </value>
		public static string Game { get; set; } = "gta5";
		...
		public static void Serialize(DefinitionGraph graph)
		{
			...
			output.AppendLine("-- FX resource definition");
			output.AppendLine("-- This file is automatically generated with `nfpm install` - any manual changes will be lost");
			output.AppendLine($"-- Generated {DateTime.Now:R}");
			output.AppendLine();

			output.AppendLine($"fx_version '{FxVersion}'");
			output.AppendLine($"game '{Game}'");
			output.AppendLine();
